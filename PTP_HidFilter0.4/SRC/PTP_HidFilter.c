...
)
{
    ...
    PVOID pHidDesc = &deviceContext->PtpHidDesc;//&DefaultHidDescriptor//
...
)
{
    ...
    hidDescriptorSize = deviceContext->PtpHidDesc.DescriptorList[0].wReportLength;//DefaultHidDescriptor.DescriptorList[0].wReportLength;
    PVOID pHidReportDesc = deviceContext->pPtpHidReportDesc;//&ParallelMode_PtpReportDescriptor
